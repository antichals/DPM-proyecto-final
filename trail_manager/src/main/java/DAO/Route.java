...
public class Route {
    ...
    // Constructor
    public Route(String id, List<LatitudeLongitude> coordinates, double length, String difficulty, String terrainType, String description, List<PointOfInterest> pointsOfInterest, double estimatedDurationInHours) {
        this.id = id;
